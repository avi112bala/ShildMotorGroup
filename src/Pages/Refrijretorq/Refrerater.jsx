...
const BookingFor = ({ next }) => {
    ...
    return (
        ...
        >
            ...
            <h5 className="text-md font-medium text-black mb-4 font-common">choose one of the method</h5>
            <div className="relative mb-4">
                <select
                    id="vehicleType"
                    value={senderdata?.loadingitem}
                    onChange={(e) => { updateSenderData({ key: "loadingitem", value: e.target.value }); }}
            ...
            {senderdata?.loadingitem === "FullLoad" && (
                <>
                    <h6 className="font-medium text-md font-common mb-4">Choose the options</h6>
                    <div className="flex items-center gap-4 mb-4">
                        <button
                            ...
                            style={{
                                backgroundColor: senderdata?.secondoption === "triaxle"
                                    ? "var(--button_background)"
                                    : "#ffffff",
                                color: senderdata?.secondoption === "triaxle"
                                    ? "#ffffff"
                                    : "#000000"
                            }}                    >
                            Tri-axle
                        ...
                        <button
                            ...
                            style={{
                                backgroundColor: senderdata?.secondoption === "tendemaxle"
                                    ? "var(--button_background)"
                                    : "#ffffff",
                                color: senderdata?.secondoption === "tendemaxle"
                                    ? "#ffffff"
                                    : "#000000"
                            }}                    >
                            tandem axle
            ...
            {senderdata?.ServiceData?.title !== "Dry Division" && <div className="relative mb-4">
                <select
                    id="vehicleType"
                    value={senderdata?.secondoptionref}
                    onChange={(e) => { updateSenderData({ key: "secondoptionref", value: e.target.value }) }}
                    className="w-full appearance-none bg-[#F8F8F8] text-black py-2 px-4 pr-10 border border-[#ccc] rounded-2xl focus:outline-none focus:ring-2 font-common"
                >
